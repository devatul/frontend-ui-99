...
var RickInsight = React.createClass({
    ...
    getRickInsight() {
        return makeRequest({
            ...
            success: (data) => {
                ...
                this.setState({ rickInsight: data, classIcon: classIcon_StaleFiles, loading: false })
            }
        });
    },
	...
	render(){
        ...
        if (this.state.rickInsight != null && this.state.rickInsight.stale_files != null) {
                                        ...
                                        <section className="panel">
                                            <div className={className}>
                                                <h4 className="widget-title">
                                                    ...
                                                    <HelpButton1 className="" classNote="overview_timeframe fix-overview-help-button" setValue={this.getRickType(index).info} />
                                                </h4>
		    ...
		    return(
            <div>
                {this.state.loading ? (<p className="text-center">Loading Risk Insights data...</p>) : (children)}

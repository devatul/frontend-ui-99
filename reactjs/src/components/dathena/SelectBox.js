...
var SelectBox = React.createClass({
  ...
  render: function () {
    let children = [],
        {binding, defaultValue, data, emptyValues} = this.props,
    ...
    _props.emptyValues && delete _props.emptyValues;
    ...
    if (emptyValues) {
      children.unshift(<option key="empty" className="lt" disabled="disabled" selected="selected" ></option>);
    }

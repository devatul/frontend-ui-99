...
var Select2 = React.createClass({
  ...
  componentDidUpdate(prevProps, prevState) {
    if (!isEqual(this.props, prevProps)) {
      let {events} = this.constructor,
          {adaptDropdownCssClass, containerCssClass, minimumResultsForSearch} = this.props;
  ...
  componentDidMount() {
    let {adaptDropdownCssClass, containerCssClass, minimumResultsForSearch} = this.props,
  ...
  render() {
    ...
    _props.adaptDropdownCssClass && delete _props.adaptDropdownCssClass;
    _props.containerCssClass && delete _props.containerCssClass;
    _props.minimumResultsForSearch && delete _props.minimumResultsForSearch;
    _props.dropdownCssClass && delete _props.dropdownCssClass;

    if (_props.closeOnSelect === false || _props.closeOnSelect === true) delete _props.closeOnSelect;

    _props.onOpen && delete _props.onOpen;

    ...
    render() {
        return (
            <div id="centroid">
                ...
                <hr className="mt-lg mb-none" />
                <div className="cendroid-chart-legend">
                    <h5>Distance</h5>
                ...
                <div className="cendroid-chart-legend right">
                    <h5>Number of the Documents</h5>
                    <span className="document-symbol"><i className="size-1"></i>1</span>
                    <span className="document-symbol"><i className="size-2"></i>2</span>
                    <span className="document-symbol"><i className="size-3"></i>3</span>
                    <span className="document-symbol"><i className="size-4"></i>4</span>
                    <span className="document-symbol"><i className="size-5"></i>5</span>
                    <span className="document-symbol"><i className="size-6"></i>6</span>
                </div>
            </div>
            );
    }
